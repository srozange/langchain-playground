...
from langchain_community.chat_models import ChatOllama  # Changement ici : ChatOllama au lieu de Ollama
...
if __name__ == "__main__":
    result = agent_executor.invoke({"input": "Add 2 and 3 and 5"})
    print(result)